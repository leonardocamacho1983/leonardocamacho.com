...
export const copy: Record<string, LocaleCopy> = {
  en: {
    ...
    confirmedHero2: 'You\u2019re in the room.',
    confirmedSeason: 'The first letter arrives <strong>Spring 2026</strong>.',
    ...
    confirmedRevealTitle: 'What we\u2019ll explore together:',
    confirmedRevealPoint1: 'How companies compound advantage through disruption, not despite it.',
    confirmedRevealPoint2: 'Why the organizations that endure don\u2019t preserve what they\u2019re made of. They preserve how the pieces hold together.',
    confirmedRevealPoint3: 'Strategy that satisfies the decade.',
    confirmedRevealTagline: 'Written to be read slowly. Designed to be revisited often.',
  ...
  'pt-br': {
    ...
    confirmedHero2: 'Voc\u00ea est\u00e1 na sala.',
    confirmedSeason: 'A primeira carta chega no <strong>Outono de 2026</strong>.',
    ...
    confirmedRevealTitle: 'O que vamos explorar juntos:',
    confirmedRevealPoint1: 'Como empresas acumulam vantagem atrav\u00e9s da disrup\u00e7\u00e3o, n\u00e3o apesar dela.',
    confirmedRevealPoint2: 'Por que as organiza\u00e7\u00f5es que perduram n\u00e3o preservam do que s\u00e3o feitas. Elas preservam como as pe\u00e7as se encaixam.',
    confirmedRevealPoint3: 'Estrat\u00e9gia que satisfaz a d\u00e9cada.',
    confirmedRevealTagline: 'Escrito para ser lido devagar. Projetado para ser revisitado com frequ\u00eancia.',
  ...
  pt: {
    ...
    welcomeOpenOutlook: 'Abrir Outlook',
    confirmedHero1: 'Confirmado.',
    confirmedHero2: 'Est\u00e1 na sala.',
    confirmedSeason: 'A primeira carta chega na <strong>Primavera de 2026</strong>.',
    ...
    confirmedRevealPoint2: 'Porque as organiza\u00e7\u00f5es que perduram n\u00e3o preservam de que s\u00e3o feitas. Preservam como as pe\u00e7as se encaixam.',
    confirmedRevealPoint3: 'Estrat\u00e9gia que satisfaz a d\u00e9cada.',
    confirmedRevealTagline: 'Escrito para ser lido devagar. Concebido para ser revisitado com frequ\u00eancia.',
    confirmedRevealLinkedin: 'Seguir no LinkedIn',
    confirmedRevealTwitter: 'Seguir no Twitter',
    thankyouHero: 'Agora come\u00e7amos.',
    thankyouExploreTitle: 'O que vamos explorar juntos',
  ...
  fr: {
    ...
    confirmedHero2: 'Vous \u00eates dans la salle.',
    confirmedSeason: 'La premi\u00e8re lettre arrive au <strong>Printemps 2026</strong>.',
    ...
    confirmedRevealTitle: 'Ce que nous allons explorer ensemble :',
    confirmedRevealPoint1: 'Comment les entreprises accumulent un avantage \u00e0 travers la disruption, pas malgr\u00e9 elle.',
    confirmedRevealPoint2: 'Pourquoi les organisations qui perdurent ne pr\u00e9servent pas ce dont elles sont faites. Elles pr\u00e9servent comment les pi\u00e8ces tiennent ensemble.',
    confirmedRevealPoint3: 'Une strat\u00e9gie qui satisfait la d\u00e9cennie.',
    confirmedRevealTagline: '\u00c9crit pour \u00eatre lu lentement. Con\u00e7u pour \u00eatre revisit\u00e9 souvent.',
